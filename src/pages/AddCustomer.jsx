...
export default function AddCustomer() {
  ...
  const [formData, setFormData] = useState({
    ...
    gender: '', email: '', phone: '', altPhone: '', poBox: '',
    street: '', building: '', city: '', postalCode: '', country: '',
    creditLimit: '', creditUsed: '', creditAvailable: '', discountPercentage: '',
  });
        ...
        <Box component="form" onSubmit={handleSubmit}>
          ...
          <TabPanel value={activeTab} index={0}>
            <Grid container spacing={3} sx={{display: 'flex', flexDirection: 'column', alignItems: 'center'}}>
              ...
              <Grid item xs={12} sm={6} sx={{ width: '60%' }}>
                <TextField fullWidth label="ID Number" name="name" value={formData.name} onChange={handleInputChange} required />
              </Grid>
              <Grid item xs={12} sm={6} sx={{ width: '60%' }}>
                <TextField fullWidth label="Date of Birth" name="dateOfBirth" value={formData.dateOfBirth} onChange={handleInputChange} required  type='date'/>
              </Grid>
              <Grid item xs={12} sm={6} sx={{ width: '60%' }}>
                <Select fullWidth name="gender" value={formData.gender} onChange={handleInputChange} label="Select your gender">
          ...
          <TabPanel value={activeTab} index={1}>
            <Grid container spacing={3} sx={{display: 'flex', flexDirection: 'column', alignItems: 'center'}}>
              ...
              <Grid item xs={12} sm={6} sx={{ width: '60%' }}>
                <TextField fullWidth label="Alternate Phone Number" name="altPhone" value={formData.altPhone} onChange={handleInputChange} />
              </Grid>
              <Grid item xs={12} sm={6} sx={{ width: '60%' }}>
                <TextField fullWidth label="P.O BOX" name="poBox" value={formData.poBox} onChange={handleInputChange} />
              </Grid>
            </Grid>
          </TabPanel>
          ...
          <TabPanel value={activeTab} index={2} >
            <Grid container spacing={3} sx={{display: 'flex', flexDirection: 'column', alignItems: 'center'}}>
              <Grid item xs={12} sm={6} sx={{ width: '60%' }}>
                <TextField fullWidth label="Street Name" name="street" value={formData.street} onChange={handleInputChange} type='number' />
              </Grid>
              <Grid item xs={12} sm={6} sx={{ width: '60%' }}>
                <TextField fullWidth label="Building Name" name="building" value={formData.building} onChange={handleInputChange} type='number'/>
              </Grid>
              <Grid item xs={12} sm={6} sx={{ width: '60%' }}>
                <TextField fullWidth label="City Name" name="city" value={formData.city} onChange={handleInputChange} type='number'/>
              </Grid>
              <Grid item xs={12} sm={6} sx={{ width: '60%' }}>
                <TextField fullWidth label="Postal Code" name="postalCode" value={formData.postalCode} onChange={handleInputChange} type='number'/>
              </Grid>
              <Grid item xs={12} sm={6} sx={{ width: '60%' }}>
                <TextField fullWidth label="Country Name" name="country" value={formData.country} onChange={handleInputChange} type='number'/>
              </Grid>
            </Grid>
          </TabPanel>
          ...
          <TabPanel value={activeTab} index={3}>
            <Grid container spacing={3} sx={{display: 'flex', flexDirection: 'column', alignItems: 'center'}}>
              <Grid item xs={12} sm={6} sx={{ width: '60%' }}>
                <TextField fullWidth label="Credit Limit" name="creditLimit" value={formData.creditLimit} onChange={handleInputChange} />
              </Grid>
              <Grid item xs={12} sm={6} sx={{ width: '60%' }}>
                <TextField fullWidth label="Credit Used" name="creditUsed" value={formData.creditUsed} onChange={handleInputChange} />
              </Grid>
              <Grid item xs={12} sx={{ width: '60%' }}>
                <TextField fullWidth label="Credit Available" name="creditAvailable" value={formData.creditAvailable} onChange={handleInputChange} />
              </Grid>
            </Grid>
          </TabPanel>
